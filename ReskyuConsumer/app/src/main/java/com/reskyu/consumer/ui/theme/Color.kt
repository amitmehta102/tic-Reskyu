...
val RGreenAccent  = Color(0xFF52B788)   // primary CTA, active nav, chips
...
val ROutline      = Color(0xFFB0CABB)   // soft green outline / date text
val RDivider      = Color(0xFFD4EDDA)   // light green divider
val RError        = Color(0xFFD32F2F)   // error / urgency red
val ROrange       = Color(0xFFE65100)   // warning orange
