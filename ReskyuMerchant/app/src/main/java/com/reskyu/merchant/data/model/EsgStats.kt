...
data class EsgStats(
    ...
    val weeklyRevenue: List<Float> = emptyList(),      // Revenue per day (7 days)
    val recoveryRateWeekly: List<Float> = emptyList(), // Sales recovery % per day (0–100)
    val completedOrders: Int = 0,
    val disputedOrders: Int = 0,
    /** heroItem name → number of completed claims. Sorted descending. */
    val topSellingItems: Map<String, Int> = emptyMap()
)
