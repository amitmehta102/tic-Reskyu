 ...
 *
 * The start destination is [Screen.SPLASH]. The SplashViewModel resolves
 * [MerchantAuthState] and navigates to LOGIN, ONBOARDING, or DASHBOARD
 * using [popUpTo] to clear the back stack.
 */
@Composable
